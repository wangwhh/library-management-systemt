...
import com.example.spring.queries.*;
...
public interface LibraryManagementSystem {
     ...
     *         and should be an instance of {@link com.example.spring.queries.BookQueryResults}
     */
    List<Book> queryBook(BookQueryConditions conditions);
     ...
     * @return query results should be returned by ApiResult.payload
     *         and should be an instance of {@link com.example.spring.queries.BorrowHistories}
     */
     ...
     *
     * @return query results should be returned by ApiResult.payload
     *         and should be an instance of {@link com.example.spring.queries.CardList}
     */
    List<Card> showCards();
